...
public class EditPostInMyAccountActivity extends AppCompatActivity {
        ...
        TextView_library.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(write && read){
                    ...
                    Toast.makeText(EditPostInMyAccountActivity.this, "읽기/쓰기 권한 필요",Toast.LENGTH_SHORT).show();
        ...
        TextView_camera.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(camera && write){
                    ...
                    Toast.makeText(EditPostInMyAccountActivity.this, "카메라 및 쓰기 권한 필요",Toast.LENGTH_SHORT).show();
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    if(mCurrentPhotoPath!=null){
                        ...
                        editPostInMyAccount(position, mCurrentPhotoPath);
...
//                        gridEditor.commit();
                        ...
                        editPostInMyAccount(position, bitmapUri.getPath());
...
//                        gridEditor.commit();
                        ...
                        String postPicture=bundle.getString("PostPicture");
                       editPostInMyAccount(position, postPicture);
                        EditProgressTask editProgressTask=new EditProgressTask();
                        editProgressTask.execute();
                    }
        ...
        TextView_position.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(EditPostInMyAccountActivity.this, PlaceSearchActivity.class);
...
//            Picasso.with(this).load(mCurrentPhotoPath).into(ImageView_image);
    ...
    public void editPostInMyAccount(int position, String uri){
        ...
        if(getSharedPreferences(Nickname,MODE_PRIVATE).getString("ProfileUri",null)==null) {
            ...
            postItemArrayList.set(getSharedPreferences("MyGridPost",MODE_PRIVATE).getInt("PostIndex"+position,0), new PostItem(
                    defaultProfileUri.getPath(),
                    uri,
                    R.drawable.like,
                    R.drawable.comment,
                    getSharedPreferences(Nickname+"GridPost",MODE_PRIVATE).getInt("PostCommentCount"+position,0),
                    R.drawable.more,
                    ...
                    getSharedPreferences("MyGridPost",MODE_PRIVATE).getInt("PostIndex"+position,0),
            ...
            PostActivity.savePostArray(EditPostInMyAccountActivity.this);


            postPictureItemArrayList.set(position,new PostItem(
                    defaultProfileUri.getPath(),
                    uri,
                    R.drawable.like,
                    R.drawable.comment,
            ...
            PostActivity.saveGridPostArray(EditPostInMyAccountActivity.this,Nickname);
        }else{
            postItemArrayList.set(getSharedPreferences("MyGridPost",MODE_PRIVATE).getInt("PostIndex"+position,0), new PostItem(
                    ...
                    longitude,
                    address,
                    getSharedPreferences(Nickname+"GridPost", MODE_PRIVATE).getString("PostTime"+position,null),
                    EditText_text.getLineCount()
        ...
        accountPostGridAdapter.notifyItemChanged(position);
    ...
    class EditProgressTask extends AsyncTask<Integer, Integer, Integer> {
        ...
        protected void onPostExecute(Integer integer) {
            ...
            Intent intent = new Intent(EditPostInMyAccountActivity.this, MyPostActivity.class);
